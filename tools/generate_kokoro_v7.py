...
def generate_kokoro_audio():
    ...
    # Initialize Kokoro with local model paths
    kokoro = Kokoro("models/kokoro/kokoro-v0_19.onnx", "models/kokoro/voices-v1.0.bin")
    ...
    for i, text in enumerate(scenes, 1):
        ...
        # Save to file
        output_path = f"voice/v7_kokoro/scene_{i}_clean.wav"
    ...
    print("Location: voice/v7_kokoro/")
